        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    VotingStartAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    VotingEndAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsVotingClosedManually = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ResultsPublished = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ResultsPublishedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    PublishedBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VotedByIp = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
